...
def get_current_single_service_group(module, base_url, headers):
    ...
    if info["status"] == 200:
        ...
        exit_failed(
            module,
            construct_error_message_for_failed_fetch_call(info, "get_current_single_service_group"),
        )
...
def update_single_service_group(module, base_url, headers):
    ...
    if info["status"] != 200:
        exit_failed(
            module,
            construct_error_message_for_failed_fetch_call(info, "update_single_service_group"),
        )
...
def create_single_service_group(module, base_url, headers):
    ...
    if info["status"] != 200:
        exit_failed(
            module,
            construct_error_message_for_failed_fetch_call(info, "create_single_service_group"),
        )
...
def delete_single_service_group(module, base_url, headers):
    ...
    if info["status"] != 204:
        exit_failed(
            module,
            construct_error_message_for_failed_fetch_call(info, "delete_single_service_group"),
        )
